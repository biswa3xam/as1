...
import com.biswa.krifynote.databinding.ActivityAddNoteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imgCheck.setOnClickListener {
            ...
            if (title.isNotEmpty() || note_desc.isNotEmpty()) {
                ...
                if (isUpdate) {
                    note = Note(oldNote.id, title, note_desc, formater.format(Date()))
                } else {
                    note = Note(null, title, note_desc, formater.format(Date()))
                }
